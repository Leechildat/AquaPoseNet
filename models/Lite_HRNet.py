...
class Stem(nn.Module):
    ...
    def __init__(self,
        ...
        # print(in_channels, stem_channels)
        self.conv1 = nn.Sequential(
...
class LiteHRNet(nn.Module):
    ...
    def __init__(self,
        ...
        for i in range(self.num_stages):
            ...
            # print("####", num_channels_last, num_channels)
            setattr(
                self, f'transition{i}',
            ...
            # print(getattr(self, f'stage{i}', stage))
        ...
        self.final_layer = nn.Conv2d(
            in_channels=40,  # extra.NUM_DECONV_FILTERS[-1]
    ...
    def _make_transition_layer(self, num_channels_pre_layer,
        ...
        # print(num_branches_cur, num_branches_pre)
    ...
    def _make_stage(self,
        ...
        # print(num_modules, num_branches, num_blocks, with_fuse)
    ...
    def forward(self, x):
        ...
        for i in range(self.num_stages):
            ...
            # print('www', len(x_list))

            # print('@@@', type(x_list[1]))
            # print('www', len(getattr(self, f'stage{i}')))
            y_list = getattr(self, f'stage{i}')(x_list)

            # print('www', len(y_list))
...
if __name__ == "__main__":
    ...
    # print(model)
    # image = torch.Tensor(8, 3, 256, 128)
    # outs = model(image)
    # print(outs.shape)
