...
config.MODEL.HRNet = 32
config.MODEL.LiteHRNet = 18


config.MODEL.NUM_STACKS = 4
...
config.LOSS.COMBINE = 'original'
config.LOSS.ALPHA = 0.0015
...
def get_model_name(cfg):
    ...
    if name in ['VNet', 'HgNet', 'PoseResNet', 'LiteHRNet', 'HRNet', 'higherHRNet']:
