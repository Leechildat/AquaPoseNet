...
def parse_args():
    ...
    parser.add_argument('--cfg',
                        ...
                        # required=True,
                        # default='experiments/HRNet/model_256×256_HRNet32.yaml',
                        # default='experiments/HRNet/model_256×256_higherHRNet32.yaml',
                        # default='experiments/HRNet/model_256×256_LiteHRNet18.yaml',
                        default='experiments/HRNet/model_256×256_LiteHRNet30.yaml',
                        type=str)
...
def main():
    ...
    if config.MODEL.NAME == 'HRNet':
        model = HRNet(config.MODEL.HRNet, 11, 0.1).cuda()   # 关键点改为11
